...
public class Last2UrduRestLatinSplitHead {

    private static final Logger LOGGER = LoggerFactory.getLogger(Last2UrduRestLatinSplitHead.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            rs = select.executeQuery("SELECT split_head, id from entries where hindi  is null and urdu is null and latin is null and split_head is not null and id = 12170");
