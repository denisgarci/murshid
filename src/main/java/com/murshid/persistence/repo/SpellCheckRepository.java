...
public interface SpellCheckRepository extends CrudRepository<SpellCheckEntry, String> {
    ...
    List<SpellCheckEntry> selectByInitialExceptSuccessful(String initial, String dictionarySource);
    ...
    List<SpellCheckEntry> selectByInitialExceptAllTried(String initial, String dictionarySource);
