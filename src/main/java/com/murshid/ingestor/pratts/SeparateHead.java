...
public class SeparateHead {

    private static final Logger LOGGER = LoggerFactory.getLogger(SeparateHead.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            rs = select.executeQuery("SELECT head, id from entries ");
            ...
            while (rs.next()) {
                ...
                if (WordUtils.scriptType(tokens[0]) != Scripts.NASTALIQ
                        ...
                        || WordUtils.scriptType(tokens[2]) != Scripts.LATIN){
                    continue;
                }
