...
public class LastUrduRestLatinSplitHead {

    private static final Logger LOGGER = LoggerFactory.getLogger(LastUrduRestLatinSplitHead.class);
...
//                }
                ...
                if (Strings.isNullOrEmpty(tokens[0]) ||  IngestorWordUtils.scriptType(tokens[0]) != Scripts.NASTALIQ){
                    continue;
                }
