...
public class PlattsCaller {

    private static final Logger LOGGER = LoggerFactory.getLogger(PlattsCaller.class);
    ...
    public static void findBoundariesForAll(String[] args) throws Exception{
        ...
        PlattsCaller plattsCaller = new PlattsCaller();
    ...
    public static void main(String[] args) throws Exception{
        ...
        for (int i =0; i < 20; i++ ) {
            ...
            URL url = plattsCaller.createUrlWithParams(1, 100 + i);
