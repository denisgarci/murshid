...
public class OnlyUrdu {

    private static final Logger LOGGER = LoggerFactory.getLogger(OnlyUrdu.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            rs = select.executeQuery(
                    "SELECT head, id from entries where hindi  is null and urdu is null and latin is null");
